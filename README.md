...
📌 Project Overview
This project is a FastAPI-based backend system for managing a Movie Ticket Booking platform. It allows users to browse movies, book tickets, hold seats, confirm bookings, and explore advanced features like search, sorting, and pagination.
